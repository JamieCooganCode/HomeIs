...
#ifdef HOMEIS_HomeIsGameMode_generated_h
#error "HomeIsGameMode.generated.h already included, missing '#pragma once' in HomeIsGameMode.h"
#endif
...
public: \
	DECLARE_CLASS(AHomeIsGameMode, AGameModeBase, COMPILED_IN_FLAGS(0 | CLASS_Transient), CASTCLASS_None, TEXT("/Script/HomeIs"), HOMEIS_API) \
...
#define HomeIs_Source_HomeIs_HomeIsGameMode_h_12_STANDARD_CONSTRUCTORS \
	...
	DECLARE_VTABLE_PTR_HELPER_CTOR(HOMEIS_API, AHomeIsGameMode); \
DEFINE_VTABLE_PTR_HELPER_CTOR_CALLER(AHomeIsGameMode); \
private: \
	/** Private move- and copy-constructors, should never be used */ \
	HOMEIS_API AHomeIsGameMode(AHomeIsGameMode&&); \
	HOMEIS_API AHomeIsGameMode(const AHomeIsGameMode&); \
public:
...
#define CURRENT_FILE_ID HomeIs_Source_HomeIs_HomeIsGameMode_h
